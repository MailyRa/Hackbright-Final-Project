...
### Landing Page
Users regirster or login on the React JS built landing page 
...
Once signed in, the users can browse the different categories of loans which includes, home, personal, educational, business, and car loans.
